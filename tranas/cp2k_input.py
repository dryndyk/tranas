"""This module defines a TraNaS interface to CP2K.

TraNaS precalculator for CP2K (https://www.cp2k.org/)
...
class CP2Kinput(Calculator):
    ...
    def __init__(self, restart=None,
        ...
        elif CP2Kinput.command is not None:
            self.command = CP2Kinput.command
